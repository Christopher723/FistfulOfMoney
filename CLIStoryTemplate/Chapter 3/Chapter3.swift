...
func chapterThree() {
    ...
    print("Our hero \(hero) walks into his next town on his journy across the country. The town looks like it can use his help.")
    for people in people where people.indeistress == true{
        sadArr.append(people)
        
    }
    while !sadArr.isEmpty{
        print(" \(hero) walks up to a town residident seeing him in distress. Please help me my name is \(sadArr[0].name), I need help with \(String(describing: sadArr[0].problem))")
